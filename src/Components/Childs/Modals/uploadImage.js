...
// import MoreNavigator from "../SvgIcons/more";

const ImageUploader = ({ children, shown, close }) => {
  return (
    <div
    ...
    >
      <div className="flex justify-center items-center cursor-pointer">
        <div
          className="border-0 w-[350px]  absolute bottom-0 left-0  right-0 top-0    bg-white"
          onClick={(e) => {
            e.stopPropagation();
          }}
        >
